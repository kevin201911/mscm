...
public class SysRoleController {
    ...
    public Object getUserRoleCheck(@RequestParam("adminId") Long adminId){
        List<SysRole> RolesByUserId=
                appUserService.findRolesByUserId(adminId);

        List<UserRoleResult> userRoleResults=
                sysRoleService.userRoleCheck(RolesByUserId);

        return new CommonResult().success(userRoleResults);
