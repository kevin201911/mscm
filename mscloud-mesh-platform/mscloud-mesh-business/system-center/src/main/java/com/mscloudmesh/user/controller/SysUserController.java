package com.mscloudmesh.user.controller;

import cn.hutool.core.bean.BeanUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;

import com.mscloudmesh.common.annotation.LoginUser;
import com.mscloudmesh.common.annotation.SysLog;
import com.mscloudmesh.common.constant.CommonConstant;
import com.mscloudmesh.common.model.*;
import com.mscloudmesh.common.utils.CommonResult;
import com.mscloudmesh.common.utils.ExcelUtil;
import com.mscloudmesh.common.utils.ValidatorUtils;
import com.mscloudmesh.user.model.SysUserExcel;
import com.mscloudmesh.user.service.ISysUserService;
...
public class SysUserController {
    ...
    public Object getAdminInfo(@LoginUser(isFull = true) SysUser user) {
        ...
        data.put("icon", user.getHeadImgUrl());
    ...
    public Object getUserByPage(SysUser entity,
        ...
        try {
            return new CommonResult().success(appUserService.page(new Page<SysUser>(pageNum, pageSize), new QueryWrapper<>(entity)));
        } catch (Exception e) {
        ...
        if(!excl.isEmpty()) {
            ...
            if (rowNum > 0) {
                ...
                list.forEach(u -> {
                    ...
                    user.setPassword(
                            CommonConstant.DEF_USER_PASSWORD);
